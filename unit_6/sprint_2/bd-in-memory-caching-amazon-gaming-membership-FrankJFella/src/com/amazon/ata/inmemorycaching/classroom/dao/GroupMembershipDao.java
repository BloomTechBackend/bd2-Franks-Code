...
public class GroupMembershipDao {
    ...
    // Method added for the manager to call if there is not hit in the cache
    // All the cache manager has is the "cache-key object"
    // This method needs to receive the "cache-key object" from the cache manager
    //     and call the usual DAO extracting the search value from the "cache-key object"
    public boolean isUserInGroup(GroupMembershipCacheKey theKey) {
        return this.isUserInGroup(theKey.getUserId(), theKey.getGroupId());
    }
