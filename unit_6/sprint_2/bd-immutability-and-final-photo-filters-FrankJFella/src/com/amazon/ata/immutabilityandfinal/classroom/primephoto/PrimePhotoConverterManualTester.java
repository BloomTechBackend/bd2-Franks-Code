...
public class PrimePhotoConverterManualTester {
    ...
    public static void main(String[] args) {
        // Call runTest() withe the original picture and a List with three conversion types
...
//         runTest("src/resources/dalmatian.jpg", ImmutableList.of(ConversionType.SEPIA));
    ...
    // runTest will start a thread for each conversion type it passed
    // concurrent conversions running at same time
    // use multi-threading
