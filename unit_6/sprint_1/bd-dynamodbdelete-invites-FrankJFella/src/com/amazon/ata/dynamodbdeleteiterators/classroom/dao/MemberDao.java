...
public class MemberDao {
    ...
    public void deletePermanently(String memberId) {
        Member aMember = new Member(); // Instantiate a Member object to hold the id of the member to be deleted
        aMember.setId(memberId);       // Set the Member object id to the id of member to be deleted
        mapper.delete(aMember);        // Ask DynamoDB to unconditionally delete the member
    }
}
