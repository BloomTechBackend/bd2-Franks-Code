...
public class EventDao {
    ...
    public Event cancelEvent(String eventId) {
        ...
        canceledEvent.setCanceled(true);  // the object in this method and teh database will have true
        mapper.save(canceledEvent);
        return canceledEvent;  // Partial event is being return (missing values in the Object)
    }
}
