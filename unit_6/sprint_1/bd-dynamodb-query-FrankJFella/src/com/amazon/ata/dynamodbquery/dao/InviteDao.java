...
public class InviteDao {
    ...
    public List<Invite> getInvitesForEvent(String eventId, String exclusiveStartMemberId) {
        // TODONE: implement
        Invite invite = new Invite();   // Use this to access the database
        invite.setEventId(eventId);     //   set its eventId to what was passed

        Map<String, AttributeValue> startKey = null;  // set to null so we get the 1st page of data

        if(exclusiveStartMemberId != null) {   // is they gave us a starting point use it
