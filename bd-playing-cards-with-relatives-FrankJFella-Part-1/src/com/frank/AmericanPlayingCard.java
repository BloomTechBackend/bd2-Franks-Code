...
public class AmericanPlayingCard extends PlayingCard{   // This is a sub-class of PlayingCard
	                                                    // We get all the data and methods from PlayingCard
	                                                    //    all we do is add any new data and methods we
	                                                    //    need for this sub-class
	...
	// default constructor - 0-args - must call a super class constructor
	// constructor - same name as the class, no return type may or may not accept parameters
	// This constructor will initialize the super class with defaults value, suit, color
	public AmericanPlayingCard() 
	{
		super(DEFAULTCARDVALUE, DEFAULTSUIT, DEFAULTCOLOR);
	} 

	// Additional - 2-arg - constructor to allow users to specify value and suit of a new AmericanPlayingCard
