...
public class PlayingCard {
	...
	// instance variables - every instance of the class gets a set of these variables
	private int    value;
	...
	public boolean equals(Object obj) {  // return a boolean and receive an Object class object I am calling obj
		...
		// if name of this class is not the same as the name of the compared object class....
		if (getClass() != obj.getClass()) {     // if the class is not the same as the object being compared to
			return false;                       //    they are not equal
		}
		// Because we need to create a PlayingCard object from the object being compared, we have have to cast object
		//     anObject   = anObject    - assign one object to another - the types/classes must match
		//                                         so Java knows how to copy data members from one to the other
		// PlayingCard    = Object class object - cannot do unless we cast to type on the left of the =
		PlayingCard other = (PlayingCard) obj;  // We need to create a PlayingCard object from the generic object
		                                        // by casting to PlayingCard class and assign to new object so we can us it
