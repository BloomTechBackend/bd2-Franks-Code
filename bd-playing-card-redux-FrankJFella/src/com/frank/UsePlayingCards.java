...
// import static com.frank.ItalianPlayingCard.pickACard;  //   if import multiple methods statically
                                                          //      expect ambiguous reference errors
                                                          //      if used without a classname or object
...
// main() is always static - there can only be one main() in an application
...
// Display all the objects in my ArrayList - Polymorphism will cause the correct showCard() for the element to be run
		...
		// neither a classname nor object was used to invoke pickACard - static import for AmericanPlayingCard was used
